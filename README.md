...
The 'dbs_bundle_260922' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/dbs_bundle_260922/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] dbs_bundle_260922_etl` to your workspace.
